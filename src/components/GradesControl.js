...
export default function GradesControl({grades, onDelete, onPersist}) {
    ...
    const handleActionClick = (id, type) => {
        ...
        const grade = grades.find(grades => grades.id === id);
        ...
        <div>
           {tableGrades.map(({id, grades}) => {
               ...
               const gradeStyle = finalGrade >= 70 ? styles.goodGrade : styles.badGrade;
                ...
                return <table style={styles.table} className="striped" key={id}>
                ...
                <tfoot>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td style={{textAlign: "right"}}><strong>Nota total:</strong></td>
